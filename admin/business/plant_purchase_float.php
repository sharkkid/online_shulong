			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="nav nav-tabs" style="font-size: 1em">
						<li class="active" ><a style="color:#242028;background-color: #dcdcdc;" href="<?php echo WT_URL_ROOT;?>/admin/business/plant_purchase.php">固定成本</a></li>
						<li class="active"><a style="color:#242028;" href="#">浮動成本</a></li>
					</ul>
							...
							foreach ($product_list as $row) {								
								echo '<tr>';//產品編號
        							...
        							if(!empty($row['total_cost'])){
        								echo '<td style="vertical-align: middle;border-right:0.1rem #BEBEBE dashed;text-align: center;">'.$row['total_cost'].'元</td>';		
	        						}
	        						// 自種苗
	        						else{        								
        								echo '<td style="vertical-align: middle;border-right:0.1rem #BEBEBE dashed;text-align: center;"></td>';   
