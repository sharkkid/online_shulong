		...
		$(document).ready(function() {
			...
			$('#adjust_form').validator().on('submit', function(e) {
				...
				$('button.export_excel').on('click', function(){
            	    window.open("plant_shipment_detail.php?export_error=1&start="+
        		...
        		<div class="row">
        			<div class="col-md-12">
        				...
        				<div id="search" style="clear:both;">
        					<form autocomplete="off" method="get" action="./plant_shipment_detail.php" id="search_form" class="form-inline alert alert-info" role="form">
        						<div class="row">
        							<div class="col-md-12">
        								<div class="form-group">
